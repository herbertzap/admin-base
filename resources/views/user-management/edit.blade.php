                            ...
                            <form action="{{ route('user-management.update', $user) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <ul class="nav nav-tabs" id="userTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="datos-tab" data-bs-toggle="tab" data-bs-target="#datos" type="button" role="tab" aria-controls="datos" aria-selected="true">Actualizar Datos</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                    ...
                                    <div class="tab-pane fade show active" id="datos" role="tabpanel" aria-labelledby="datos-tab">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" name="name" class="form-control bg-white text-dark border @error('name') is-invalid @enderror" value="{{ old('name', $user->name) }}" required>
                                                @error('name')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="email" name="email" class="form-control bg-white text-dark border @error('email') is-invalid @enderror" value="{{ old('email', $user->email) }}" required>
                                                @error('email')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" name="rut_usuario" class="form-control bg-white text-dark border @error('rut_usuario') is-invalid @enderror" value="{{ old('rut_usuario', $user->rut_usuario) }}">
                                                @error('rut_usuario')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                @if($user->fotografia)
                                                    <div class="mt-2">
                                                        <img src="{{ $user->fotografia_url }}" alt="Fotografía actual" class="img-thumbnail" style="max-height: 100px;">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control bg-light" value="{{ $user->password ? '••••••••••••••••' : 'Sin contraseña' }}" readonly>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control bg-light" value="{{ $user->created_at ? $user->created_at->format('d/m/Y \a \l\a\s H:i:s') : 'N/A' }}" readonly>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">Último Movimiento</label>
                                                <input type="text" class="form-control bg-light" value="{{ $user->ultimo_movimiento ? $user->ultimo_movimiento->format('d/m/Y \a \l\a\s H:i:s') : 'N/A' }}" readonly>
                                            </div>
                                            <div class="col-md-12 mb-3">
                                                <label class="form-label">Renovación</label>
                                                <input type="text" class="form-control bg-light" value="{{ $user->needsPasswordRenewal() ? 'Quedan ' . $user->getDaysUntilPasswordRenewal() . ' días para renovar su contraseña, le enviaremos un email informando.' : 'No requiere renovación' }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="privilegios" role="tabpanel" aria-labelledby="privilegios-tab">
                                        <div class="row">
                                            <div class="col-12 mb-3">
                                                <h6>{{ $user->name }} tiene acceso a:</h6>
                                            </div>
                                            <div class="col-12">
