                            ...
                            @if($resultados)
                                <div class="box box-solid">
                                    <div class="box-body no-padding table-responsive">
                                        <table class="table table-hover table-striped" id="busquedaTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            @if($resultado['modelo'] === 'Tatc')
                                                                <a href="{{ route('control-plazos.show', ['tipo' => 'tatc', 'id' => $resultado['id']]) }}" 
                                                                   class="btn btn-sm btn-info" 
                                                                   title="Ver Detalle TATC">
                                                                    <i class="fas fa-eye"></i> Ver
                                                                </a>
                                                            @elseif($resultado['modelo'] === 'Tstc')
                                                                <a href="{{ route('control-plazos.show', ['tipo' => 'tstc', 'id' => $resultado['id']]) }}" 
                                                                   class="btn btn-sm btn-info" 
                                                                   title="Ver Detalle TSTC">
                                                                    <i class="fas fa-eye"></i> Ver
                                                                </a>
                                                            @elseif($resultado['modelo'] === 'Salida')
                                                                <a href="{{ route('salidas.show', $resultado['id']) }}" 
                                                                   class="btn btn-sm btn-info" 
                                                                   title="Ver Detalle Salida">
                                                                    <i class="fas fa-eye"></i> Ver
                                                                </a>
                                                            @endif
                                                        </td>
                                    ...
                                    @if($resultados->count() > 0)
                                        <div class="box-footer clearfix">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6 text-center help-block">
                                                <!-- Botones de exportar movidos arriba -->
                                            </div>
                                            <div class="col-xs-12 col-sm-3 col-md-3">
                                            </div>
                                        </div>
