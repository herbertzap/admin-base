<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <x-navbars.navs.auth titlePage="Nueva Aduana"></x-navbars.navs.auth>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('aduana-chiles.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="nombre_aduana" class="form-control @error('nombre_aduana') is-invalid @enderror" value="{{ old('nombre_aduana') }}" required>
                                        @error('nombre_aduana')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mt-3">
                                    <button type="submit" class="btn btn-primary">Crear Aduana</button>
