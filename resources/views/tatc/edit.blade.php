            ...
            <div class="row">
                <div class="col-12">
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">
                                    <i class="fas fa-edit"></i> Actualizar TATC #{{ $tatc->numero_tatc }}
                                </h6>
                            </div>
                        </div>
                        ...
                        @if(!$tatc->puedeSerModificado())
                            <div class="card-body">
                                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                    ...
                                    <strong>Advertencia:</strong> Este TATC no puede ser modificado porque ya tiene salidas registradas.
                        ...
                        @else
                            <div class="card-body">
                                <form method="POST" action="{{ route('tatc.update', $tatc->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
